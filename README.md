...
- 🎫 **TicketSurge** — an event-driven ticketing platform tackling seat overselling under high concurrency, built for portfolio and placement interview prep.
- 🦻 **HaptiHear** — an ESP32-based haptic hearing-aid wearable using TinyML sound classification.

### Tech

- **Languages:** C++, Java, Python, SQL
- **ML / Data:** NumPy, pandas, scikit-learn, matplotlib, computer vision
- **Backend / Infra:** Django REST Framework, PostgreSQL, Redis, RabbitMQ, Celery, Docker
- **Frontend:** React
- **Embedded / IoT:** ESP32, TinyML
